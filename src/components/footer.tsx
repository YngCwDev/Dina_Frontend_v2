...
import LOGO from "./../../public/svg/LOGO-w.svg";
    ...
    <>
      <footer className="bg-zinc-900 text-white">
        <div className="container mx-auto px-4 py-8 md:px-[10%]">
          <div className="flex flex-wrap justify-center gap-8 md:flex-nowrap md:gap-28">
            ...
            <div className="flex flex-col">
              ...
              <Link
                href="/contact"
                className="mt-4 hover:text-red-800 transition-colors"
              >
                Contact Us
              </Link>
            </div>
        ...
        <div className="border-t border-gray-800 py-4 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Dina Holding. All rights reserved.
          </p>
        </div>
      </footer>
    </>
        ...
        <div className="container mx-auto px-4 py-8 md:px-[10%]">
          <div className="flex flex-wrap justify-center gap-8 md:flex-nowrap md:gap-28">
            ...
            {footerSections.slice(1).map((section, index) => (
              <div
                key={section.title}
                className={`order-${index + 1} flex flex-col md:order-${
                  index + 2
                }`}
              >
                <nav aria-label={`${section.title.toLowerCase()} links`}>
